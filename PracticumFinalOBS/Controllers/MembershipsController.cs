...
namespace PracticumFinalOBS.Controllers
{
    public class MembershipsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MembershipName,Description,DurationInDays,DiscountRate,Fee")] Membership membership)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MembershipName,Description,DurationInDays,DiscountRate,Fee")] Membership membership)
        {
            if (id != membership.Id)
            {
                return NotFound();
